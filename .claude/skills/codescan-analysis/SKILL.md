...
| `codescan project-update <id> [opts]` | 프로젝트 경로/설명 수정 (재스캔 없이) | `codescan project-update 1 --path D:\new` |
...
- `codescan` CLI 명령 (list, search, project, projects, project-addinfo)
- Read 도구로 소스 파일 읽기
